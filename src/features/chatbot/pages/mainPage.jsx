      ...
      <div className="min-h-screen bg-app text-app flex flex-col">
        ...
        <div className="flex-1 flex flex-col w-full mx-auto px-57">
          ...
          <main className="flex-1 py-8 flex flex-col gap-10">
            ...
            {/* Recent section */}
            <section>
              <h2 className="text-base font-medium text-app opacity-80 mb-5">
                Recent notebooks
              </h2>
              ...
              {view === "grid" ? (
                ...
                <div className="flex flex-col gap-2 max-w-2xl">
                  <button
                    ...
                    className="flex items-center gap-4 px-4 py-3 rounded-xl border-2 border-dashed border-app-border hover:border-black/30 dark:hover:border-white/40 hover:bg-black/5 dark:hover:bg-white/5 transition-all group"
                  >
                    <div className="w-9 h-9 rounded-full border-2 border-app-border group-hover:border-black/40 dark:group-hover:border-white/60 flex items-center justify-center transition-colors shrink-0">
                      <Plus size={18} className="text-app opacity-50 group-hover:opacity-80" />
                    </div>
                    <span className="text-sm text-app opacity-60 group-hover:opacity-80 transition-colors">
                      Create new notebook
                    </span>
                  </button>
                  {recent.map((nb) => (
